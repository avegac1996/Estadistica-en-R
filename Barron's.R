...
#Datos del Ejercicio (ejercicio 25 pag.646):
x1 = c(3.7,3.4,2.5,4.8,4.0,3.0,2.7,1.7,2.2,1.4) #vector de ejecucion de la operacion 
x2 = c(4.5,3.0,4.0,3.7,3.5,3.0,2.5,3.5,2.7,3.6) #vector de uso
x3 = c(4.8,4.2,4.0,3.4,3.2,4.6,3.3,3.1,3.0,2.5) #vector de gama
y = c(4.0,3.5,3.5,3.5,3.5,3.5,3.0,3.0,2.5,2.0) #vector de estrellas
i = c(1:length(x1))  #vector del n???mero de corredores enumerados del 1 al 10
...
#install.packages("rgl") #instala el paquete rld para graficar en 3D
#plot3d(x1, x2, y, pch = 19, col=18) #grafico de dispersion x2
ejem2 = lm(y ~ x1 + x2 + x3) #calculo de la regresion lineal (funcion directa)
...
print (influence(ejem2)) #valores atipicos
