...
#####  IMPORTANTE: Guiarse en la diapositiva 47 para ver los 8 pasos para llegar a la respuesta  ####
...
i = c(1:length(x))  #vector del n???mero de pizzerias enumeradas del 1 al 10
...
t_tabla2 = qt(0.01/2,8,lower.tail = FALSE)
...
F_tabla2 = qf(0.01,1,8, lower.tail = FALSE)
